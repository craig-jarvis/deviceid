...
func (b *Builder) AddOsVersion() error {
	return fmt.Errorf("AddOsVersion not supported on %s", runtime.GOOS)
}

func (b *Builder) AddSerialNumber() error {
	return fmt.Errorf("AddSerialNumber not supported on %s", runtime.GOOS)
}

func (b *Builder) AddSystemUuid() error {
	return fmt.Errorf("AddSystemUuid not supported on %s", runtime.GOOS)
}
